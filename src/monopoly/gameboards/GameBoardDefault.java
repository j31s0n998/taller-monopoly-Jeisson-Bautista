...
public class GameBoardDefault extends GameBoard {
    public GameBoardDefault() {
        ...
        CardCell cc1 = new CardCell(CardType.CC, "Cofre comunitario ");
        ...
        CardCell c1 = new CardCell(CardType.CHANCE, "Oportunidad");
        ...
        CardCell cc2 = new CardCell(CardType.CC, "Cofre comunitario 2");
        ...
        CardCell c2 = new CardCell(CardType.CHANCE, "Oportunidad 2 ");
        ...
        CardCell cc3 = new CardCell(CardType.CC, "Cofre comunitario 3");
        PropertyCell g3 = new PropertyCell();
        RailRoadCell rr4 = new RailRoadCell();
        CardCell c3 = new CardCell(CardType.CHANCE, "Oportunidad 3");
        ...
        super.addCard(new MoneyCard("Gano $50", 50, CardType.CC));
        super.addCard(new MoneyCard("Gano $20", 20, CardType.CC));
        super.addCard(new MoneyCard("Gano $10", 10, CardType.CC));
        super.addCard(new MoneyCard("Perdio $100", -100, CardType.CC));
        super.addCard(new MoneyCard("Perdio $50", -50, CardType.CC));
        ...
        super.addCard(new MoneyCard("Gano $50", 50, CardType.CHANCE));
        super.addCard(new MoneyCard("Gano $20", 20, CardType.CHANCE));
        super.addCard(new MoneyCard("Gano $10", 10, CardType.CHANCE));
        super.addCard(new MoneyCard("Lose $100", -100, CardType.CHANCE));
        super.addCard(new MoneyCard("Perdio $50", -50, CardType.CHANCE));
