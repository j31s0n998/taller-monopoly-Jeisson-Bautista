...
public class PlayerPanel extends JPanel {
    ...
    public PlayerPanel(MainController mainController, Player player) {
        ...
        rollDiceButton = new JButton("Tirar el dado");
        purchasePropertyButton = new JButton("Comprar propiedad");
        endTurnButton = new JButton("Fin del turno");
        buyHouseButton = new JButton("Comprar casa");
        getOutOfJailButton = new JButton("salir de la cárcel");
        drawCardButton = new JButton("Elegir Carta");
        tradeButton = new JButton("Comerciar");
        this.player = player;
